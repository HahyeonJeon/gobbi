...
### Step-by-step recipes in skills
...
**User feedback:** Agents should understand the principle and make their own plan, not follow a script.

**Correct approach:** Describe what needs to be true (principles, constraints, quality gates), not how to get there. Let the agent plan based on the actual task.
