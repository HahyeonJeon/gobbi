...
- Point #13 trace must be disambiguated in Execution — "P7" alone is ambiguous between `coding/SKILL.md` P7 (Build Bottom-Up) and `principles/SKILL.md` P7 (Say/Write Plainly). See `checklists/process/review-communication-principle-trace.md`.
...
- Point #13 principle trace disambiguation (codex-structure-002, Med/100): must be resolved in Execution. See `checklists/process/review-communication-principle-trace.md`.
