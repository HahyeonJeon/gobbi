...
User selected **Draft A** (full) at Planning Loop iter 2 entry. Manager carries this verbatim text into Task 05 brief at WORK entry.
...
- `evaluation/SKILL.md:98-110` — Coverage Ownership Matrix schema (3 columns) + existing-row tone.
