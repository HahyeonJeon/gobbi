...
Split from the env-var-audit ideation references bundle (Reference 1). Consulted via assistant subagent lookup during the Ideation loop; informed locked design decisions in the Idea artifact.
