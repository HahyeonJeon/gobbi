...
- [docs-as-code-linting](docs-as-code-linting.md) — the mechanical gate that enforces this schema conformance
- [markdown-memory-atomicity](markdown-memory-atomicity.md) — the atomic-markdown memory architecture the schema rides on
