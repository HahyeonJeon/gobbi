---
name: adr-decision-record-shape
description: "Reference: Nygard ADR template — Context/Decision/Consequences — as the canonical shape for decision docs, anchoring the per-type section contract for decisions and design docs."
scope: feature
