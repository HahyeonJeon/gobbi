...
- **Open residual (CONSIST-2):** the rule names the authority but does not provide a drift-detection mechanism. See `features/coding/decisions/memory/2026-06-27-authoritative-source-drift-detection-gap.md`.
