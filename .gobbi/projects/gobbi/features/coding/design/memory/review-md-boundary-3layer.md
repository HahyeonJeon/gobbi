...
- [ ] The authoritative-source rule is present (see `features/coding/design/memory/review-md-authoritative-source-rule.md`).
...
- CONSIST-2 (Low/50): the authoritative-source rule names the authority but no drift-detection mechanism exists. Accepted residual. See `features/coding/decisions/memory/2026-06-27-authoritative-source-drift-detection-gap.md`.
