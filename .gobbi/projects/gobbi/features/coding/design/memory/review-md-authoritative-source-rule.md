...
- CONSIST-2 (Low/50): drift-detection gap. The rule is named but no mechanism automatically detects when one doc diverges from the other. Accepted residual. See `features/coding/decisions/memory/2026-06-27-authoritative-source-drift-detection-gap.md`.
