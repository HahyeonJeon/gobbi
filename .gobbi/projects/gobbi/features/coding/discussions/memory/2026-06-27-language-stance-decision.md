...
- Execution must pass the language-silo validation method (see `features/coding/checklists/process/language-silo-validation-method.md`): property-based review + grep pre-check.
