...
| [Design Execution](../../../skills/design/design-execution/SKILL.md) | Operation | Placeholder for one settled visual-design task. | Procedure is not written yet. Gains no Review or acceptance authority. |
