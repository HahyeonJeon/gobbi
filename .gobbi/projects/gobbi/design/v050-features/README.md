...
| [gobbi-memory/README.md](gobbi-memory/README.md) | Three-tier memory under `.gobbi/`. Project memory subdirs (design, decisions, gotchas, ...). Per-session `.gobbi/projects/<name>/sessions/<id>/gobbi.db` event log + workspace-root `.gobbi/gobbi.db` memories projection. |
