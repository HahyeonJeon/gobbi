...
| [gobbi-memory/README.md](gobbi-memory/README.md) | Three-tier memory under `.gobbi/`. Project memory subdirs (design, decisions, gotchas, ...). Per-session `gobbi.db` event log + workspace `gobbi.db` memories projection. |
