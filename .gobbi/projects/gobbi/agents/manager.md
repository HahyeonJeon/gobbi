...
|---|---|---|
| `pi` (innovative + best stances) | `leader` | Dual-stance retired; single leader per dispatch. Cross-pollination now comes from dual-system evaluation — see `orchestration/delegation.md` § Anti-trust Block. |
