...
|---|---|---|
| `pi` (innovative + best stances) | `leader` | Dual-stance retired; single leader per dispatch. Cross-pollination now comes from independent dual-system creation and evaluation in the [Workflow](../skills/workflow/SKILL.md). |
