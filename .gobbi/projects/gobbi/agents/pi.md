...
- `gotcha` — check for known pitfalls before starting any investigation, planning, or review
...
- `agents-doc` — when the plan involves creating or modifying agent definitions
