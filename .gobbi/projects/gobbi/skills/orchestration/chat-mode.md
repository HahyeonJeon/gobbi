...
| 3 | `EVALUATION` | Run per `workflow.planning.evaluate.mode` (default `always`). | manager orchestration: [evaluation.md](workflow/evaluation.md); specialist phase load: [../evaluation/SKILL.md](../evaluation/SKILL.md) + phase child [../planning/evaluation.md](../planning/evaluation.md) | evaluator |
...
| 3 | `EVALUATION` | Run per `workflow.execution.evaluate.mode` (default `always`). | manager orchestration: [evaluation.md](workflow/evaluation.md); specialist phase load: [../evaluation/SKILL.md](../evaluation/SKILL.md) + phase child [../execution/evaluation.md](../execution/evaluation.md) | evaluator |
| 4 | `RECORD` | Runs the unmodified base `record/SKILL.md` procedure per §4. | manager orchestration: [record.md](workflow/record.md); specialist phase load: [../record/SKILL.md](../record/SKILL.md) (+ [../memory/memory-map.md](../memory/memory-map.md)) | assistant |
...
| # | Phase | Action | Refs | Agent |
|---|---|---|---|---|
| 1 | `DISCUSSION` | Forced user-driven per §9. Manager + user confirm consolidation scope. | manager orchestration: [discussion](../discussion/SKILL.md); specialist phase load: — | manager |
...
| 3 | `EVALUATION` | Run per `workflow.wrap-up.evaluate.mode` (default `always`). | manager orchestration: [evaluation.md](workflow/evaluation.md); specialist phase load: [../evaluation/SKILL.md](../evaluation/SKILL.md) + phase child [../wrap-up/evaluation.md](../wrap-up/evaluation.md) | evaluator |
