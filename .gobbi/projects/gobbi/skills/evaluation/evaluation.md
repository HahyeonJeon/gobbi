...
- Does the perspective follow gobbi's documentation standards — `claude` writing principles, naming convention, file structure?
...
- Does the perspective avoid `claude` anti-patterns: no code examples, no BAD/GOOD comparisons, no step-by-step recipes?
