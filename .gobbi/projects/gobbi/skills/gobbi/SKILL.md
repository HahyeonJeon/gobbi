...
- Read applicable repository instructions, every applicable project rule, and the canonical
  [manager role](../../agents/claude/manager.md) for Claude, [grok/manager.md](../../agents/grok/manager.md) for Grok, and [codex/manager.toml](../../agents/codex/manager.toml) for Codex. Record `NO_PROJECT_RULES: rules/ absent-or-empty` when the rules
...
| [Manager role](../../agents/claude/manager.md) | Defines session authority, routing, assignment, and acceptance. Runtime copies: [Grok](../../agents/grok/manager.md), [Codex](../../agents/codex/manager.toml). |
