...
| [`coding`](../coding/SKILL.md) | Language-agnostic construction quality. | Relevant whenever the task writes or reviews code. |
| [`desktop`](../desktop/SKILL.md) | Electron and TypeScript desktop delivery as a complete vertical slice. | Relevant to an installed windowed application. |
| [`html`](../html/SKILL.md) | HTML semantics, accessibility, compatibility, and verification. | Relevant when work writes or reviews HTML. |
| [`css`](../css/SKILL.md) | CSS cascade, rendering, resilience, performance, and verification. | Relevant when work writes or reviews CSS. |
| [`python`](../python/SKILL.md) / [`typescript`](../typescript/SKILL.md) | Language-specific implementation methods. | Relevant when the task enters that language. |
| [`react`](../react/SKILL.md) | React purity, state, boundaries, accessibility, and testing. | Relevant when work writes or reviews React. |
| [`electron`](../electron/SKILL.md) | Electron process, security, lifecycle, build, and packaging method. | Relevant when work writes or reviews Electron. |
| [`codex`](../codex/SKILL.md) | Native Codex and Codex-peer invocation surfaces. | Load when the active runtime is Codex or a Codex peer operation is used. |
...
- Load [`../mistake/SKILL.md`](../mistake/SKILL.md) before non-trivial work and
  [`../codex/SKILL.md`](../codex/SKILL.md) when the active runtime or a peer operation requires it.
