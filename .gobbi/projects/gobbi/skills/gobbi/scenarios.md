...
- **Then:** it loads the selected orchestration owner, `mistake`, `codex`, shared delegation owner, or
...
### GOBBI-SCN-09-B — Mandatory but lazy mistake load

- **Given:** the manager is about to begin non-trivial work.
- **When:** it applies conditional loads.
- **Then:** `mistake` loads before the work without joining the five-skill floor.
- **Failure:** `mistake` is skipped or becomes a sixth floor skill.
- **Sources:** GB-2, GB-4.
