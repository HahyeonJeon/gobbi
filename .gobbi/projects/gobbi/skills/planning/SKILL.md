---
name: planning
description: MUST load for Planning. Decomposes locked Ideation into ordered tasks, dependencies, assignments, and artifacts.
...
| `sessions/{date}-{session-id}/planning/staging/discussions/{slug}.md` | assistant (MEMORIZATION) | per substantive user-decision topic |
