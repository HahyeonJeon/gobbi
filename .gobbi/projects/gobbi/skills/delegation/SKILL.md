...
**When to split vs combine** — If two subtasks need the same role, same context, and same files, combine them. Docs-cleanup batches that touch 3-5 related markdown files under the same context prefer a single sequential dispatch.
