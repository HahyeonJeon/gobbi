...
Naming and formatting standards for branches, commits, PRs, issues, and worktree directories. These conventions apply when git is active. All formats align with the Conventional Commits v1.0.0 standard.
