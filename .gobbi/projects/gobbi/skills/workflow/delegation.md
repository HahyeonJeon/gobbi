...
4. the current Workflow productive-step skill or selected Cowork stage skill, including `memory` for Cowork
   Wrap-up;
5. task-specific language, tool, Git, evaluation, record, scenario, or checklist skills that the selected
