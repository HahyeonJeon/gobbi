...
- Require each evaluator to apply the complete
  [Evaluation guidelines](../../evaluation/SKILL.md#procedure) to the full frozen Ideation subject. Each
  finding uses the parent-owned finding fields and states `blocking: yes|no`.
