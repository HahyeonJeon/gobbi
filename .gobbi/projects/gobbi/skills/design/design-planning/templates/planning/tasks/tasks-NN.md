...
> **Result:** [Design Planning](../plan-index.md)<br>
...
task, or table row across parts.}

## Work Summary

{Keep the Work Summary in the first listed part only.}
...
| Design | {The accepted visual design and decisions that shape execution.} |
...
traceable decomposed task and not automatically an agent assignment. The Plan combines one or more compatible
leaves into each task group.

### {Numeric path} — {Group title}
