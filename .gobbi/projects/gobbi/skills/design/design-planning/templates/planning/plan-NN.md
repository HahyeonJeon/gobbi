...
| Accountable role | {Designer for a visual-work group.} |
| Compatible skills | {Include Design Execution for a visual-work group.} |
...
- **Accepted design:** {The accepted visual design and decisions that shape execution.}
- **Writer frontier:** {The visual files and artifacts this task group may change.}
