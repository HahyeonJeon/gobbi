...
| Document | Covers |
|----------|--------|
| [rules-doc](../../rules-doc) | Authoring rule files in `.claude/rules/` |
| [project-doc](../../project-doc) | Authoring project docs in `$CLAUDE_PROJECT_DIR/.claude/project/{project-name}/` |
| [skills-doc](../../skills-doc) | Creating and modifying skill definitions in `.claude/skills/` |
| [agents-doc](../../agents-doc) | Creating and modifying agent definitions in `.claude/agents/` |
| [transcripts.md](transcripts.md) | Subagent transcript recovery — location, JSONL schema, extraction paths, plan data |
| [gotchas.md](gotchas.md) | Known mistakes and corrections for claude |
...
These formatting rules apply to all `.claude/` documentation.

- Use backtick formatting for specific file or directory paths — e.g., `$CLAUDE_PROJECT_DIR/.claude/project/{project-name}/`
