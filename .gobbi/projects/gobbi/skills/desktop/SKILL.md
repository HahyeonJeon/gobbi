---
name: desktop
description: "MUST load before coordinating an installable Electron and TypeScript application outcome, defining its observable desktop-platform contract, or making desktop release judgments. Desktop is a domain skill that routes the task to its applicable operation, tool, and preference child skills."
allowed-tools: Read
skill-type: domain
---
...
| [`desktop-platform`](desktop-platform/SKILL.md) | tool | Use when defining or reviewing observable installed-desktop behavior across targets, entry modes, windows, lifecycle, native integration, local data, installation, updates, and recovery. |
