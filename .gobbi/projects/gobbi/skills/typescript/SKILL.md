...
| [`typescript-toolchain`](typescript-toolchain/SKILL.md) | tool | MUST load when TypeScript work involves compiler configuration, module resolution, imports, emit, type stripping, linting, building, or runtime host differences. |
