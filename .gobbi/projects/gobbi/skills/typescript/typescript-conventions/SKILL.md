...
TypeScript Conventions owns the source-level choices that make typed code predictable to read: names, file layout, imports, documentation, comments, and formatting. It does not decide type semantics, runtime architecture, or compiler configuration.
...
Put a definition near its owner and make promotion to shared code follow demonstrated reuse.
...
- Prefer colocated narrow helpers and tests; promote to a shared location after independent consumers demonstrate the shared contract.
