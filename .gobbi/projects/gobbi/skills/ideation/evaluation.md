...
Test the three-phase order, document authority, dynamic topic hierarchy, parent-before-child resolution, concern ownership, component boundaries, interfaces, dependency direction, state and data invariants, and test seams. Confirm a child contradiction reopens and propagates through the earliest affected parent in `ideation.md`, and that specialized evidence informs this self-contained method without importing another procedure.
