...
description: "Preference Skill Writing is guidance for writing a judgment-focused skill with binding constraints and overridable defaults."
allowed-tools: Read, Grep, Glob, Bash, Write, Edit
skill-type: operation
---

# Preference Skill Writing

Preference Skill Writing defines how to author or substantively revise guidance for choices, constraints, defaults, and justified departures. Use it after Gobbi Skill classifies the target as `preference`.
