...
Gobbi Skill guides authors when they create, substantively revise, migrate, or split a project skill. Use it to classify the target as domain, operation, tool, or preference, establish the common skeleton-first contract, and route the author to the matching type-writing skill.
...
- Frame the approved skill through its narrowest actor, applicability, observable outcome, judgment or routing
...
description: "{one or two identity-only sentences that contain the H1 title}"
...
- [`domain-skill`](domain-skill/SKILL.md) owns domain-skill-family writing.
- [`operation-skill`](operation-skill/SKILL.md) owns operation-skill writing.
- [`tool-skill`](tool-skill/SKILL.md) owns tool-skill writing.
- [`preference-skill`](preference-skill/SKILL.md) owns preference-skill writing.
