...
platform understanding, valid project choices, and declarative motion. Concerns owned
...
| [`css-motion`](css-motion/SKILL.md) | preference | MUST load when specifying, implementing, or reviewing declarative motion in CSS, covering transitions, keyframe animations, the duration and easing scale, safe-to-animate properties, entry, exit, and choreography, and reduced-motion implementation. |
