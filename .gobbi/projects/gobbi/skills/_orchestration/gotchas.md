...
**Correct approach:** When spawning evaluator agents, always include the appropriate perspective evaluation docs in the delegation prompt. For project deliverable evaluation: `_project/evaluation/project.md`, `_project/evaluation/overall.md`, plus `architecture.md`, `performance.md`, or `aesthetics.md` as needed. For skill evaluation: `_skills/evaluation/` perspective docs. For agent evaluation: `_agents/evaluation/` perspective docs. The evaluation docs define the structured criteria — the orchestrator selects which perspectives to use, but never invents criteria.
