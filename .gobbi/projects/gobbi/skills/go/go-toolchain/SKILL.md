---
name: go-toolchain
description: "Load when using or diagnosing the Go distribution, go command, compiler, formatter, vet, generators, build constraints, platform builds, or project-pinned Go tools."
