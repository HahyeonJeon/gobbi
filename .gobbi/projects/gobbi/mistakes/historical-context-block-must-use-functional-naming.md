...
The `claude` doc standard (Chain-of-Docs, principles-over-procedures) does not preclude this — it's a drift-detector-specific tactic. The detector's auditability comes from its content-blindness; this mistake is the cost.
