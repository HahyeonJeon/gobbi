...
promoted_from: sessions/2026-05-22-bac669ad-4fec-40b5-8387-51ac57bc0d3d/ideation/staging/backlogs/project/f-struct-01-jq-sh-env-passthrough.md
...
In the task that authors or refines `.claude/hooks/session-start.sh`, add a second illustrative snippet for the passthrough env-var case alongside the stdin-JSON example. Recommended patterns:
