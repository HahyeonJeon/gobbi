...
- **D2-040** (Low, conf 25) — RESOLVED by removal of both obsolete owners. `interview/SKILL.md` was removed with its startup replacement (2026-07-13); `skill-writing/templates/project-skill.md` was removed after Preparation was absorbed into Planning and a fresh reference sweep proved no live consumer remained (2026-07-19). No generated skill now inherits Claude-only `AskUserQuestion` from this path. (Relates to D2-021.)
