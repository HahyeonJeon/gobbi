...
iter2_fix_list:
  - "Fix 1 — Concern 3 RESOLVED (user selected Draft A); verbatim cell text inlined throughout."
  - "Fix 2 — All session paths absolute (/playinganalytics/git/gobbi/.gobbi/projects/gobbi/sessions/2026-05-23-7ea62d36-e826-4ce6-9e90-9e948007b068/...)."
  - "Fix 3 — Task 04 brief discipline strengthened to mirror Task 06: Read-required directive + 5-Type vocab + 4-category gap table verbatim + verification gate."
  - "Fix 4 — Removed residual `_claude/SKILL.md` references (Concern 5)."
  - "Fix 5 — Added `manager-iter2-brief-failed-iron-law-7-verbatim-spec-recheck.md` to Task 01 Required mistakes."
  - "Fix 6 — Optional (markdown anchors over line refs) — SKIPPED to avoid Iron Law 11 gaming risk (would require rewriting evaluation/SKILL.md to add stable anchor IDs first; out-of-scope this iter)."
---

# Planning Draft — Iter 2 (REVISE re-entry)
...
>
> **Iter 2 changes (surgical fix — no re-design):** Concern 3 RESOLVED (user selected Draft A; row text inlined verbatim throughout). All session paths converted to absolute form per `mistakes/codex-eval-session-write-path-nested-in-worktree.md`. Task 04 brief discipline strengthened to match Task 06. Residual `_claude/SKILL.md` references removed. `manager-iter2-brief-failed-iron-law-7-verbatim-spec-recheck.md` added to Task 01 Required mistakes. No task count change, no dependency-graph change, no locked-decision re-opening.

---

## Scope reference

**Source contract** — `idea.md:31-93` at `/playinganalytics/git/gobbi/.gobbi/projects/gobbi/sessions/2026-05-23-7ea62d36-e826-4ce6-9e90-9e948007b068/ideation/artifacts/idea.md` (Scope Contract LOCKED at Ideation iter3 PASS).
...
**RESOLVED — user selected Draft A.** The verbatim row text (inlined throughout Plan + Task 05 brief):
...
**Manager-review status:** RESOLVED (user selected Draft A). No AskUserQuestion needed at WORK entry. Task 05 brief inlines the row text verbatim (the cell content IS the brief). Decision record at `/playinganalytics/git/gobbi/.gobbi/projects/gobbi/sessions/2026-05-23-7ea62d36-e826-4ce6-9e90-9e948007b068/planning/staging/decisions/concern-3-coverage-ownership-cell-text.md` updated to `disposition: addressed`.
...
This is a known, intentional divergence per Decisions Locked. **Recommendation: keep the body block per locked Idea Design A (8 H2 section contract).** No User Challenge — the contract supersedes convention this session.
...
**Manager-review status:** auto-resolved per Idea Decisions Locked. Note for Execution task A: ensure the Constraints body block annotation references "body block per locked Idea Design A (8 H2 section contract)" — no references to non-existent files.
...
what: |
  ...
  #
  # 2. (5-TYPE VOCABULARY VERBATIM) The 5 Types are inlined here for the executor's reference but the canonical file MUST still be re-read before edit:
  ...
  #
  # 5. (COD-CONS-003 INLINE FIX) If any illustrative example is authored that cites Domain= field, use 'test' not 'testing'. Verify with `! grep -q 'Domain=\`testing\`' .agents/skills/wrap-up/SKILL.md`.
  #
  # 6. (CROSS-LINK MANIFEST 4+5+6) The Step 2.5 body MUST cite evaluation/SKILL.md at least twice (5-Type source + Slug+collision policy source). Verify with `grep -c 'evaluation/SKILL.md' .agents/skills/wrap-up/SKILL.md | awk '$1 >= 2 {exit 0} {exit 1}'`.
traces-to:
...
verifies:
  ...
  - "grep -E 'scenario_gap|checklist_gap|design_flaw|assumption_risk|general' .agents/skills/wrap-up/SKILL.md | wc -l | awk '$1 >= 5 {exit 0} {exit 1}'  # 5-Type vocab verbatim, ≥5 matching lines (Fix 3 verification gate)"
...
traces-to:
  ...
  - "/playinganalytics/git/gobbi/.gobbi/projects/gobbi/sessions/2026-05-23-7ea62d36-e826-4ce6-9e90-9e948007b068/planning/staging/decisions/concern-3-coverage-ownership-cell-text.md (RESOLVED — Draft A selected)"
...
Rationale: Task 01 (F+G polish) ships first — lowest risk, no deps, establishes worktree+PR rhythm and gives manager early signal on git mode. Task 02 (memorization B) is the link target for tasks 03 + 05, ships before either. Task 03 wires delegation hard gate immediately after — small surface, focused. Task 04 (wrap-up Step 2.5) is the largest single-file edit besides codex — runs before codex to keep the largest task last. Task 05 (Coverage Ownership) consumes the user-selected Concern 3 Draft A text (inlined verbatim in Task 05 brief), runs after Task 02 to avoid memorization/SKILL.md conflict. Task 06 (codex content fill) is the biggest deliverable, last in main sequence — rebases onto Task 01's gobbi/SKILL.md edits. Task 07 is the cross-link sweep that gates EVALUATION readiness.
...
- **Required mistakes:**
  ...
  - `/playinganalytics/git/gobbi/.gobbi/projects/gobbi/sessions/2026-05-23-7ea62d36-e826-4ce6-9e90-9e948007b068/preparation/staging/decisions/manager-iter2-brief-failed-iron-law-7-verbatim-spec-recheck.md` (Fix 5 — Task 01 also has verbatim-spec deps: 1-question Step 4 wording must come verbatim from `gobbi/SKILL.md` source, not memory)
- **Justification (non-default choices):** none — pure default executor + sonnet for a small Edit-only task. Brief MUST inline the verbatim 1-question Step 4 wording (per Iron Law 7) — copy from `gobbi/SKILL.md` source as it currently stands, not from brief or memory.
...
- **Required mistakes:** codex-eval-session-write-path (worktree); `/playinganalytics/git/gobbi/.gobbi/projects/gobbi/sessions/2026-05-23-7ea62d36-e826-4ce6-9e90-9e948007b068/preparation/staging/decisions/manager-iter2-brief-failed-iron-law-7-verbatim-spec-recheck.md` (session-staged; brief verbatim-spec-recheck — extremely relevant since Task 02 must edit principle text verbatim per Idea Design B)
...
- **Required mistakes:** codex-eval-session-write-path, `/playinganalytics/git/gobbi/.gobbi/projects/gobbi/sessions/2026-05-23-7ea62d36-e826-4ce6-9e90-9e948007b068/preparation/staging/decisions/manager-iter2-brief-failed-iron-law-7-verbatim-spec-recheck.md`
...
- **Required mistakes:** codex-eval-session-write-path; `/playinganalytics/git/gobbi/.gobbi/projects/gobbi/sessions/2026-05-23-7ea62d36-e826-4ce6-9e90-9e948007b068/preparation/staging/decisions/manager-iter2-brief-failed-iron-law-7-verbatim-spec-recheck.md` (DIRECT PRECEDENT — Task 04 author MUST `Read /playinganalytics/git/gobbi/.gobbi/projects/gobbi/skills/evaluation/SKILL.md` lines 344-393 BEFORE writing Step 2.5 to copy 5-Type vocabulary verbatim, not from brief or memory)
- **Justification:** default executor; brief MUST include the verbatim 5-Type list AND the 4-category gap table AND a directive to re-read evaluation/SKILL.md:344-393 immediately before writing. This is the highest-risk task for vocabulary-from-memory regression. Brief discipline now mirrors Task 06's 6 explicit directives (see Task 04 `what:` BRIEF DISCIPLINE block).
...
- **Required mistakes:** codex-eval-session-write-path; `/playinganalytics/git/gobbi/.gobbi/projects/gobbi/sessions/2026-05-23-7ea62d36-e826-4ce6-9e90-9e948007b068/preparation/staging/decisions/manager-iter2-brief-failed-iron-law-7-verbatim-spec-recheck.md`
- **Justification:** default. Briefing contains the user-selected Draft A cell text VERBATIM (Concern 3 RESOLVED at iter 2 entry); brief inlines the verbatim cell text from Task 05 `what:` field. No memory-based reconstruction permitted.
...
- **Required mistakes:**
  ...
  - `/playinganalytics/git/gobbi/.gobbi/projects/gobbi/sessions/2026-05-23-7ea62d36-e826-4ce6-9e90-9e948007b068/preparation/staging/decisions/manager-iter2-brief-failed-iron-law-7-verbatim-spec-recheck.md` (the brief construction discipline mistake — author MUST `Read` Idea Design A `idea.md:269-274` verbatim before authoring each H2's body content)
...
- **Required mistakes:** `/playinganalytics/git/gobbi/.gobbi/projects/gobbi/sessions/2026-05-23-7ea62d36-e826-4ce6-9e90-9e948007b068/preparation/staging/decisions/manager-iter2-brief-failed-iron-law-7-verbatim-spec-recheck.md`
...
`grep -nE "TBD|TODO|to be defined|<\\.\\.\\.>|XXX|FIXME"` — verified: zero occurrences in task scopes, success criteria, or verification commands. The Concern 3 user-decision Plan-level NEEDS_CONTEXT from iter1 is RESOLVED at iter 2 entry (user selected Draft A); Task 05 brief now inlines verbatim cell text — no placeholders remain.
...
- **File paths** — all source-of-truth paths confirmed via empirical `ls`/`grep` checks before draft write (Preparation `preparation.md:73-86`). Session paths absolute throughout (Fix 2 — per `mistakes/codex-eval-session-write-path-nested-in-worktree.md`).
- **No residual `_claude/SKILL.md` references** (Fix 4 — Concern 5 cleanup).
...
**Status: PASS.** All Sub-step E checks (Spec coverage / Placeholder / Type-name consistency) clear. Concern 3 RESOLVED at iter 2 entry — no remaining Plan-level NEEDS_CONTEXT.
...
- **Markdown anchors over line refs in Cross-Link Manifest 4/5/6** (Fix 6, OPTIONAL) — SKIPPED this iter: would require adding stable anchor IDs to evaluation/SKILL.md first (out-of-scope file edit). Iron Law 11 (no gaming the tool) says do not invent fake anchors; line refs preserved as evidence-based citations. Stage as backlog candidate at Wrap-up.
...
- **Bundle Task 04 (D) with Task 05 (E)** — both reference `evaluation/SKILL.md`. **Rejected:** Task 04 only references it (reads, doesn't edit); Task 05 edits it. No real overlap. Separating preserves Task 05's verbatim-cell-text discipline.
...
| P3 | Concern 3 (Coverage Ownership Matrix cell text) | RESOLVED — user selected Draft A at Planning iter 2 entry. Row text inlined verbatim throughout Plan + Task 05 brief. Decision record updated to `disposition: addressed`. | User selection at iter 2 entry; `/playinganalytics/git/gobbi/.gobbi/projects/gobbi/sessions/2026-05-23-7ea62d36-e826-4ce6-9e90-9e948007b068/planning/staging/decisions/concern-3-coverage-ownership-cell-text.md` |
...
| P5 | Concern 5 (Constraints body block vs H2) | KEEP body block per locked 8-H2 Idea contract. Constraints block annotation references "body block per locked Idea Design A (8 H2 section contract)" — no references to non-existent skill files. | `idea.md` Decisions Locked + empirical 6/6 sample |
...
Files `Read` during this Planning Loop's DISCUSSION + WORK (iter 1 + iter 2):

- `.claude/skills/principles/SKILL.md` (Iron Laws 1, 4, 7, 11, 12)
...
- `/playinganalytics/git/gobbi/.gobbi/projects/gobbi/sessions/2026-05-23-7ea62d36-e826-4ce6-9e90-9e948007b068/ideation/artifacts/idea.md` (locked Scope Contract)
- `/playinganalytics/git/gobbi/.gobbi/projects/gobbi/sessions/2026-05-23-7ea62d36-e826-4ce6-9e90-9e948007b068/preparation/artifacts/preparation.md` (handoff)
...
- `/playinganalytics/git/gobbi/.gobbi/projects/gobbi/sessions/2026-05-23-7ea62d36-e826-4ce6-9e90-9e948007b068/preparation/staging/decisions/manager-iter2-brief-failed-iron-law-7-verbatim-spec-recheck.md`
- `/playinganalytics/git/gobbi/.gobbi/projects/gobbi/sessions/2026-05-23-7ea62d36-e826-4ce6-9e90-9e948007b068/planning/staging/decisions/concern-3-coverage-ownership-cell-text.md` (updated to `disposition: addressed` at iter 2 entry)
...
- **iter 1 codex evaluation outputs**: `/playinganalytics/git/gobbi/.gobbi/projects/gobbi/sessions/2026-05-23-7ea62d36-e826-4ce6-9e90-9e948007b068/planning/evaluation/iter1/codex/{overall,project,structure,usage,consistency,risk}.md`
- **iter 1 Claude evaluation outputs**: `/playinganalytics/git/gobbi/.gobbi/projects/gobbi/sessions/2026-05-23-7ea62d36-e826-4ce6-9e90-9e948007b068/planning/evaluation/iter1/claude/`
- **iter 1 draft**: `/playinganalytics/git/gobbi/.gobbi/projects/gobbi/sessions/2026-05-23-7ea62d36-e826-4ce6-9e90-9e948007b068/planning/rawdata/draft-iter1.md` (preserved as audit)
...
- **iter 2 entry**: `grep -c "USER DECISION REQUIRED" draft-iter1.md` → 1 (Concern 3 marker, RESOLVED at iter 2 entry); `grep -c "_claude/SKILL.md\|claude/SKILL.md" draft-iter1.md` → 7 (all removed in iter 2)
