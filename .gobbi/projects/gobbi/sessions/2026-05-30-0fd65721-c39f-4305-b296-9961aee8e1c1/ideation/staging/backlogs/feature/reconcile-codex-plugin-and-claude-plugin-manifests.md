---
title: "Reconcile .codex-plugin and .claude-plugin manifests (dual-ecosystem authoring)"
type: backlogs
scope: feature
...
this session (scope is the Claude plugin + the skill, not a Codex refactor). The claude-plugin skill should
