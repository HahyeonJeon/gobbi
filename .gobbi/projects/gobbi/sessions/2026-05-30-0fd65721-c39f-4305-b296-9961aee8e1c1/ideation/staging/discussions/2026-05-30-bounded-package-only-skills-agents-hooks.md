...
- `ideation/rawdata/discussion-log.md` (L34-35)
- `ideation/staging/references/plugin-cache-symlink-dereferencing-and-path-traversal.md`
- `ideation/staging/references/prior-gobbi-core-plugin-package-history.md`
- `ideation/artifacts/gobbi-plugin-ideation.md` § DD-2 (REPLACED)
