...
- live `ls plugins/ .claude-plugin/` at worktree root → both ABSENT.
- reference `ideation/staging/references/marketplace-json-schema-and-skills-dir-plugins.md` (bare `"./..."` string; resolves to marketplace root).
