...
check_contains ".agents/skills/delegation/SKILL.md" 'uses role-specific effort from the wrapper' "Delegation model selection documents Codex role effort"
check_contains ".agents/skills/delegation/SKILL.md" '`leader` remains `xhigh`' "Delegation model selection keeps leader xhigh"
check_not_contains ".agents/skills/delegation/SKILL.md" 'All agents run at max effort' "Delegation model selection does not apply max-effort defaults"
