...
check_contains ".agents/skills/gobbi/SKILL.md" 'Codex, agents inherit the parent session model and reasoning effort' "Gobbi operating conventions document Codex model inheritance"
check_not_contains ".agents/skills/gobbi/SKILL.md" 'All agents run at max effort' "Gobbi operating conventions do not apply Claude effort defaults to Codex"
check_contains ".agents/skills/delegation/SKILL.md" 'Codex inherits the parent session model and effort' "Delegation model selection documents Codex inheritance"
check_not_contains ".agents/skills/delegation/SKILL.md" 'All agents run at max effort' "Delegation model selection does not apply Claude effort defaults to Codex"
