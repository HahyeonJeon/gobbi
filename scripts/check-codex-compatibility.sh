...
check_contains ".agents/skills/orchestration/delegation.md" 'single canonical skill root for both runtimes' "Delegation names the .gobbi SSOT workspace skill root"
...
check_not_contains ".agents/skills/orchestration/delegation.md" 'workspace skills under `\.claude/skills/`' "Delegation uses runtime-aware workspace skill root"
