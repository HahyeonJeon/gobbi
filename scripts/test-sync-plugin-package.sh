...
workflow-owner-pass-only^.gobbi/projects/gobbi/skills/workflow/SKILL.md^MUST continue only from a verified PASS^MUST continue from PASS or REVISE^Workflow finding gate must preserve the full predicate, user boundary, fresh evaluation, and PASS-only continuation
phase1-owner-in-contract^.gobbi/projects/gobbi/skills/workflow/phase-1/SKILL.md^`blocking: no`, in-contract, reversible^`blocking: no`, out-of-contract, reversible^Workflow Phase 1 finding gate must preserve the full predicate, user boundary, fresh evaluation, and PASS-only continuation
phase1-owner-user-boundary^.gobbi/projects/gobbi/skills/workflow/phase-1/SKILL.md^Send every other finding to the user.^Correct every other finding automatically.^Workflow Phase 1 finding gate must preserve the full predicate, user boundary, fresh evaluation, and PASS-only continuation
phase1-owner-fresh-evaluation^.gobbi/projects/gobbi/skills/workflow/phase-1/SKILL.md^non-external finding, then require fresh evaluation.^non-external finding, then reuse prior evaluation.^Workflow Phase 1 finding gate must preserve the full predicate, user boundary, fresh evaluation, and PASS-only continuation
phase1-owner-pass-only^.gobbi/projects/gobbi/skills/workflow/phase-1/SKILL.md^only a workflow PASS continues automatically.^workflow PASS or REVISE continues automatically.^Workflow Phase 1 finding gate must preserve the full predicate, user boundary, fresh evaluation, and PASS-only continuation
phase2-owner-in-contract^.gobbi/projects/gobbi/skills/workflow/phase-2/SKILL.md^`blocking: no`, in-contract, reversible^`blocking: no`, out-of-contract, reversible^Workflow Phase 2 finding gate must preserve the full predicate, user boundary, fresh evaluation, and PASS-only continuation
phase2-owner-user-boundary^.gobbi/projects/gobbi/skills/workflow/phase-2/SKILL.md^Send every other finding to the user.^Correct every other finding automatically.^Workflow Phase 2 finding gate must preserve the full predicate, user boundary, fresh evaluation, and PASS-only continuation
phase2-owner-fresh-evaluation^.gobbi/projects/gobbi/skills/workflow/phase-2/SKILL.md^finding, then obtain fresh evaluation.^finding, then reuse prior evaluation.^Workflow Phase 2 finding gate must preserve the full predicate, user boundary, fresh evaluation, and PASS-only continuation
phase2-owner-pass-only^.gobbi/projects/gobbi/skills/workflow/phase-2/SKILL.md^Only PASS continues^PASS or REVISE continues^Workflow Phase 2 finding gate must preserve the full predicate, user boundary, fresh evaluation, and PASS-only continuation
phase3-owner-in-contract^.gobbi/projects/gobbi/skills/workflow/phase-3/SKILL.md^`blocking: no`, in-contract, reversible^`blocking: no`, out-of-contract, reversible^Workflow Phase 3 finding gate must preserve the full predicate, user boundary, fresh evaluation, and PASS-only continuation
