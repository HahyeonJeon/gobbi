...
export const GOBBI_PERMISSIONS: string[] = [
  ...
  'Skill(_gotcha)',
  'Skill(_claude)',
  'Skill(_claude_skills)',
  'Skill(_claude_agents)',
  'Skill(_discuss)',
  'Skill(_ideation)',
  'Skill(__ideation_evaluation)',
  'Skill(_plan)',
  'Skill(__plan_evaluation)',
  'Skill(_delegation)',
  'Skill(_execution)',
  'Skill(__execution_evaluation)',
  'Skill(_evaluation)',
  'Skill(_note)',
  'Skill(_note:*)',
  'Skill(_collection)',
  'Skill(_notification)',
  'Skill(__evaluation_project)',
  'Skill(__evaluation_architecture)',
  'Skill(__evaluation_performance)',
  'Skill(__evaluation_aesthetics)',
  'Skill(__evaluation_overall)',
  'WebSearch'
];
