...
How to write skill content that actually helps agents reason — description craft, instruction writing, content pruning, and failure patterns. Loaded from gobbi-claude-skills SKILL.md.
