...
- Comparing skill versions (that's __skills-comparator)
- Suggesting improvements (that's __skills-analyzer)
...
- `_claude-skills` — skill structure and verification concepts
...
- The grader never suggests fixes — that responsibility belongs to __skills-analyzer
