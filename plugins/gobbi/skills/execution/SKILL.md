...
- Review the complete implementation and diff for task alignment, consistency across dependent surfaces,
  unsupported complexity, stale or unsafe content, unexpected churn, and undocumented compatibility changes.
  Inspect affected observable behavior directly and confirm unrelated work is unchanged.
