...
| [`typescript-cli-delivery`](typescript-cli-delivery/SKILL.md) | operation | MUST load when producing, validating, installing, releasing, rolling back, or recovering a non-package TypeScript command-line application such as a bundled executable, installed script, or workspace-distributed command. |
