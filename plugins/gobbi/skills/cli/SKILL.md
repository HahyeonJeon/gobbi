---
name: cli
description: "MUST load before working in CLI. CLI is a domain skill that routes line-oriented TypeScript command-line work to its applicable operation, tool, and preference child skills."
allowed-tools: Read
skill-type: domain
---
