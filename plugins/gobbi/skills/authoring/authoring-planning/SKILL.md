---
name: authoring-planning
description: "Authoring Planning is an operation for turning defined writing work into a traceable task hierarchy, a dependency-valid execution plan, and the assignment contract those require."
...
Authoring Planning turns accepted writing work into a fine-grained task hierarchy, a flat,
dependency-valid execution plan, and the assignment contract those require.
Use it when scope and direction are defined for writing work but that work still needs decomposition, grouping, order, and dispatch.
...
### Plan only the writing writer frontier

Default each writing-work task group to the Author role, a writer frontier that includes durable
prose, and Authoring Execution among its compatible skills. A leaf whose writer frontier is not
durable prose is out-of-frontier work for this operation.
...
- **MUST record the assignment contract for each task group.** Include its `task-NN-slug` ID and title, exact
  ...
  scope.
- **MUST plan only writing-work leaves into Author-owned groups whose compatible skills include
  Authoring Execution and whose writer frontier includes durable prose.** Return a leaf whose writer
  frontier is not durable prose to the caller as out-of-frontier work; do not combine it into a
  writing-work group.
...
- Read the writing work, purpose, scope, output, accepted writing design, evidence, required skills,
...
| Name | Description |
|---|---|
| [Authoring Planning checklist](checklist.md) | Reusable unchecked source for evaluating Authoring Planning work and complete current indexed results. |
...
| [Authoring](../SKILL.md) | Routes defined writing work that still needs decomposition to this operation. |
| [Authoring Ideation](../authoring-ideation/SKILL.md) | Prior owner that settled material writing-design choices this plan must follow. |
| [Authoring Execution](../authoring-execution/SKILL.md) | Later owner of each dependency-ready writing-work task group. |
