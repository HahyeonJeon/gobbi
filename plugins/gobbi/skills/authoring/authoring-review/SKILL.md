...
description: "Authoring Review is an operation for independent critique of one frozen writing subject and for writing an evidence-based report plus working checklist."
...
Inspect and freeze the actual writing subject, then criticize it, then prepare checklist coverage.
